...
<table><caption>게시글 수정</caption>
	<tr><th>제목</th><td><input type="text" name="article_title" value="${article.article_title}"
		required="required" autofocus="autofocus"></td></tr>
	<tr><th>내용</th><td><textarea rows="5" cols="30" name="article_content" 
		required="required">${article.article_content }</textarea></td></tr>
