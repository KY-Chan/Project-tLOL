...
<body class="text-center">
		<form class="form-signin" method="post" action="join.do" name="frm">	
			...
			<div class="mt-1 form-floating">
				<input type="password" class="form-control" placeholder="비밀번호" name="account_pw" required="required" maxlength="20">
				<label for="floatingInput">Password</label>	
			</div>
			<div class="form-floating">
				<input type="text" class="form-control" placeholder="닉네임" name="account_nickname" required="required" maxlength="20">
				<label for="floatingInput">Nickname</label>	
			</div>
			<div class="mt-1 form-floating">
				<input type="email" class="form-control" placeholder="e-mail" name="account_email" required="required" maxlength="30">
